$(document).ready(function () {
  ...
  $('.about_btn').on('click', function () { //To show and hide menu in mobile footer
  ...
  $(".register, .main_reg, .register-button").on('click', function () {//To show and hide register, authorization and recover lists
    $(".hidden").toggleClass('hidden');
  ...
  $(".signin_btn, .authorization").on('click', function () {//To show and hide register, authorization and recover lists
    $(".hidden").toggleClass('hidden');
  ...
  $(".reset-button").on('click', function () {//To show and hide register, authorization and recover lists
    $(".hidden").toggleClass('hidden');
  ...
  $(".navbar_brand").on('click', function () {//To show and hide register, authorization and recover lists when click logo
    $(".hidden").toggleClass('hidden');
    $(".reset_form").fadeOut(600);
    $(".authorization_form").fadeOut(600);
    $(".reg_form").fadeOut(600);
